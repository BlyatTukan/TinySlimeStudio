...
$(function() {
  ...
  if(bgndKenburns2.length){
    bgndKenburns2.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1200x1200-bg-kenburns-4.webp" },
        { src: "img/backgrounds/1200x1200-bg-kenburns-5.webp" },
        { src: "img/backgrounds/1200x1200-bg-kenburns-6.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  if(bgndKenburnsFull.length){
    bgndKenburnsFull.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1920x1280-bg-kenburns-1.webp" },
        { src: "img/backgrounds/1920x1280-bg-kenburns-2.webp" },
        { src: "img/backgrounds/1920x1280-bg-kenburns-3.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  };
  ...
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2024, 10, 7), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
